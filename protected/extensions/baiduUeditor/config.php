...
return  array(
    ...
    //"imagePathFormat"=> "/upload/img/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    "imagePathFormat"=> Yii::app()->params->uploadDir. "{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    "scrawlPathFormat"=> Yii::app()->params->uploadDir. "{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    "snapscreenPathFormat"=> Yii::app()->params->uploadDir. "{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    "catcherPathFormat"=> Yii::app()->params->uploadDir. "{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
