            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="WIDemail" value="moreovernet@163.com" />
                        <span>必填
</span>
                    </dd>
                    <dt>付款账户名：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDaccount_name" value="再者网络科技（大连）有限公司" />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDpay_date" value="20170127" />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_no" value="20170127001" />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_fee" value="0.01" />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="130" name="WIDdetail_data" value="" />
