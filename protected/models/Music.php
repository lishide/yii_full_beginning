...
//            array('createtime', 'required'),
            ...
            array('title, singer, album', 'length', 'max' => 200),
            array('edittime', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, title, singer, album, createtime, createby, edittime, editby', 'safe', 'on' => 'search'),
        );
    }
    ...
    {
        return Music::model()->find('title=:title', array(':title' => $title));
    }
}
