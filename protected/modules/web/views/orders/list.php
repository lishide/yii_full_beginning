...
$this->cs->registerCssFile(App()->baseUrl . '/css/custom/web_orders_list.css'._resourceVer());
...
$this->cs->registerScriptFile(App()->baseUrl . '/js/custom/web_orders_list.js'._resourceVer());
                    ...
                    <div class="am-u-sm-12 am-u-md-9 am-u-lg-8 am-u-sm-centered detail-mb">
                        ...
                        <div class="am-u-sm-9 am-u-md-8">
                            <div class="am-u-sm-8">
                                ...
                                <p class="price">
                                    {{order.goods[0].name}} * {{order.goods[0].amount}}
                                </p>
                                <p class="price">
                                    ￥{{order.price}} {{getOrderStatus(order.status)}}
                                </p>
                            </div>
                            <button v-if="user" @click="detail(order.sn)" type="button"
                                    class="btn-buy am-btn am-btn-warning am-round am-u-sm-4">
                                详情
                            </button>
